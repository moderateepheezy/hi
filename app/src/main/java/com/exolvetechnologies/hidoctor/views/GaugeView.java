...
//Credit https://github.com/CodeAndMagic/GaugeView
package com.exolvetechnologies.hidoctor.views;
...
public class GaugeView extends View {
    ...
    public static final float SCALE_END_VALUE = 40.0f;
    ...
    public static final float[] RANGE_VALUES = {10.0f, 18.5f, 25.0f, 35.0f, 40.0f};
    public static final int[] RANGE_COLORS = {Color.rgb(231, 32, 43), Color.rgb(232, 111, 33), Color.rgb(27, 202, 33),
                                              Color.rgb(232, 231, 33), Color.rgb(231, 32, 43)};
	...
	public Paint getDefaultNeedleRightPaint() {
		final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
		paint.setColor(Color.rgb(255, 64, 129));
		paint.setShadowLayer(0.01f, 0.005f, -0.005f, Color.argb(255, 255, 64, 129));
		return paint;
	}
	...
	private void setNeedleShadowPosition(final float angle) {
		if (angle > 180 && angle < 360) {
			...
			mNeedleLeftPaint.setShadowLayer(0.01f, -0.005f, 0.005f, Color.argb(255, 255, 64, 129));
        } else {
			// Move shadow from left to right
			mNeedleLeftPaint.setShadowLayer(0, 0, 0, Color.BLACK);
			mNeedleRightPaint.setShadowLayer(0.01f, 0.005f, -0.005f, Color.argb(255, 255, 64, 129));
		}
	}
